...
Tropy vise donc à offrir une infrastructure legère à la portée des historiennes et des historiens pour répondre aux besoins concrets qui émergent lors des phases de collecte puis d'organisation et d'analyse des sources historiques qui se présentent, de plus en plus, sous forme de fichiers d'images en provenance de divers centres d'archives et souvent de formats hétéroclites (PDF, formats images tels JPEG, PNG etc). En particulier, il s'agit d'offrir un dispositif logiciel spécifique pour (re)construire l'archive d'une recherche donnée afin d'effectuer les opérations suivantes&#x202F;: 
