...
La leçon offre la possibilité d'accéder à trois jeux de données afin d'opter pour celui qui correspond au mieux aux intérêts - et aux niveaux des compétences numériques - des lecteurs et des lectrices. Les affiches numérisées de Mai 68, auxquelles il est possible d'accéder au moyen d'une recherche simple sur le site de [Gallica](http://gallica.bnf.fr/), la bibliothèque numérique de la Bibliothèque nationale de France (ci-après BnF) et de ses institutions partenaires. La licence d'utilisation de ces images ne permet pas le partage d'un jeu de données constitué par nos soins, c'est pourquoi des explications sont fournies séparément pour celles et ceux qui souhaitent se servir d'un script en [R](https://www.r-project.org/) afin de collecter ces données. Le deuxième jeu de données consiste aux affiches du [mouvement du Printemps érable québécois de 2012](https://fr.wikipedia.org/wiki/Gr%C3%A8ve_%C3%A9tudiante_qu%C3%A9b%C3%A9coise_de_2012) disponibles sous licence libre sur un site qui sert d'archive vivante de la production visuelle du mouvement en question. Enfin, le troisième jeu de données rassemble l'ensemble de photos sous licence libre et indexées sous le mot-clé Occupy Wall Street qui sont disponible sur le réseau social numérique Flickr. Ces fichiers ont été téléchargés en utilisant l'API de Flickr à l'aide d'un script R. Le jeu de données est accessible aux utilisatrices et utilisateurs qui souhaitent l'utiliser pour réaliser les étapes de cette leçon. De brèves explications sont fournies ci-dessous d'abord pour contextualiser puis pour accéder à chaque jeu de données. 

### Le jeu de donées des affiches de Mai 68
...
[Lien vers les fichiers pour obtenir les fichiers numérisés des affiches de Mai 68] 
