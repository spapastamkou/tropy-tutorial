...
<!--about-->
En ce qui concerne la documentation d'utilisation, un guide  officiel est [disponible en anglais](https://docs.tropy.org/) dont une traduction partielle (officieuse) en français, effectuée en 2019, peut s'avérer utile pour le lectorat francophone. Il existe aussi divers tutoriels dont certains audiovisuels. Si vous souhaitez en savoir plus, merci de consulter la [section afférente des références bibliographiques](#tutoriels-et-ressources-éducatives-en-français) <!-- vérifier le lien ancre-->.
