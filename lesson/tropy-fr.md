...
Pour découvrir comment travailler avec Tropy, l'intention originelle était d'utiliser un corpus d'environ quatre cents affiches numérisées de [Mai 1968 en France](https://fr.wikipedia.org/wiki/Mai_68) accessibles sur le site de Gallica. Ces affiches, à l'origine des [sérigraphies](https://fr.wikipedia.org/wiki/S%C3%A9rigraphie) pour la plupart, ont été principalement des créations du dit [Atelier populaire de l'Ecole des Beaux-Arts](https://www.persee.fr/doc/mat_0769-3206_1988_num_11_1_403852) de Paris lors de l'occupation de cette école en mai-juin 1968, mais aussi d'ateliers de lutte du même type qui se sont constitués dans d'autres villes (Montpellier, Marseille, Strasbourg...). Plusieurs bibliothèques et musées disposent leurs propres collections des affiches de Mai 68. La valeur de Gallica est de donner accès à une collection numérisée quasi-complète qui rassemble des items physiquement présents dans diverses institutions. Les numérisations datent des années 2010 et font partie des opérations en masse qui ont constitué le patrimoine numérique français à l'époque qui a suivi l'inauguration du projet de Google Library (aujourd'hui en berne). Elles témoignent aussi de la patrimonialisation de l'évènement de Mai 68 et de l'effet de celle-ci sur la création et mise à disposition de la source numérisée. 

Les fichiers images des affiches sont téléchargeables en format PDF ou JPEG depuis le site de Gallica, mais il ne faut pas croire qu'elles sont accessibles directement, il est en revanche possible d'y accéder à partir de pages générées à la suite d'une requête. Autrement dit, le premier pas pour constituer le corpus des affiches de Mai 68 est de formuler une demande en se servant des fonctionnalités de recherche de Gallica, que ce soit du moteur de recherche simple ou d'une recherche avancée. Dans le fichier de documentation joint, il est expliqué comment effectuer une recherche simple pour obtenir, en résultats de recherche, une liste de 458 notices correspondant, majoritairement, aux affiches de Mai 68. 

Après génération des résultats, il est possible d'inspecter les notices des affiches. Chaque notice inclut un champ qui renseigne sur les droits d'utilisation. Nous savons ainsi que les affiches de la collections de la BnF sont consultables en ligne et une barre à droite permet de les télécharger en mode image (JPEG) ou documnet (PDF). De même, nous apprenons que les fichiers d'affiches appartenant à des institutions partenaires de la BnF [peuvent être seulement consultables en ligne et pas téléchargeables du tout](https://bibliotheques-specialisees.paris.fr/ark:/73873/pf0001704515) - même s'il reste évidemment toujours possible, à des fins re recherche et dans un cadre privé, d'effectuer des captures d'écran. Une enquête auprès du Département Images et prestations numériques de la BnF     

Je vous remercie pour votre message, mais je suis au regret de vous dire que les affiches de mai 68 datant de moins de 70 ans ne sont pas dans le domaine public et donc pas libre de droits.

section droit de la notice de Gallica précise
